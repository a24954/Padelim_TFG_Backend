...
namespace TFGBackend.Data.Migrations
{
    ...
    [Migration("20240602152704_DeleteFields")]
            ...
            modelBuilder.Entity("TFGBackend.Models.Partido", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPartido = 1,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(671),
                            Duration = "2 horas",
                            Estrellas = "5",
                            IdUser = 1,
                            Name = "Partido 1",
                        ...
                        {
                            IdPartido = 2,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(675),
                        ...
                        {
                            IdPartido = 3,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(677),
                            Duration = "2 horas",
                            Estrellas = "4.5",
                            IdUser = 3,
                            Name = "Partido 3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Pista", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPista = 1,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(517),
                            Description = "Pista 1",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 1",
                            Photo = "photo1",
                        ...
                        {
                            IdPista = 2,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(564),
                            Description = "Pista 2",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 2",
                            Photo = "photo2",
                        ...
                        {
                            IdPista = 3,
                            Date = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(566),
                            Description = "Pista 3",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 3",
                            Photo = "photo3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdSesion = 1,
                            IdUser = 1,
                            ReservationDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(600),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 2,
                            IdUser = 2,
                            ReservationDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(630),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 3,
                            IdUser = 3,
                            ReservationDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(633),
                            ReservationPrice = "10"
                        });
                });
            ...
            modelBuilder.Entity("TFGBackend.Models.Sesion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdSesion = 1,
                            IdPista = 1,
                            SesionDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(651),
                            SesionTime = "10:00"
                        },
                        new
                        {
                            IdSesion = 2,
                            IdPista = 2,
                            SesionDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(653),
                            SesionTime = "12:00"
                        },
                        new
                        {
                            IdSesion = 3,
                            IdPista = 3,
                            SesionDate = new DateTime(2024, 6, 2, 17, 27, 3, 847, DateTimeKind.Local).AddTicks(655),
                            SesionTime = "14:00"
                        });
                });
