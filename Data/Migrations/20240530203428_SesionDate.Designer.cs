...
namespace TFGBackend.Data.Migrations
{
    ...
    [Migration("20240530203428_SesionDate")]
    partial class SesionDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TFGBackend.Models.Partido", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPartido = 1,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(2010),
                            Duration = "2 horas",
                            Estrellas = "5",
                            IdUser = 1,
                            Name = "Partido 1",
                        ...
                        {
                            IdPartido = 2,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(2013),
                        ...
                        {
                            IdPartido = 3,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(2016),
                            Duration = "2 horas",
                            Estrellas = "4.5",
                            IdUser = 3,
                            Name = "Partido 3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Pista", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPista = 1,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1862),
                            Description = "Pista 1",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 1",
                            Photo = "photo1",
                        ...
                        {
                            IdPista = 2,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1905),
                            Description = "Pista 2",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 2",
                            Photo = "photo2",
                        ...
                        {
                            IdPista = 3,
                            Date = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1907),
                            Description = "Pista 3",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 3",
                            Photo = "photo3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdSesion = 1,
                            IdUser = 1,
                            ReservationDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1971),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 2,
                            IdUser = 2,
                            ReservationDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1975),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 3,
                            IdUser = 3,
                            ReservationDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1977),
                            ReservationPrice = "10"
                        });
                });
            ...
            modelBuilder.Entity("TFGBackend.Models.Sesion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdSesion = 1,
                            IdPista = 1,
                            SesionDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1991),
                            SesionTime = "10:00"
                        },
                        new
                        {
                            IdSesion = 2,
                            IdPista = 2,
                            SesionDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1993),
                            SesionTime = "12:00"
                        },
                        new
                        {
                            IdSesion = 3,
                            IdPista = 3,
                            SesionDate = new DateTime(2024, 5, 30, 22, 34, 28, 625, DateTimeKind.Local).AddTicks(1995),
                            SesionTime = "14:00"
                        });
                });
