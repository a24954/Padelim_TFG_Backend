...
namespace TFGBackend.Data.Migrations
{
    ...
    [Migration("20240603164911_Status")]
            ...
            modelBuilder.Entity("TFGBackend.Models.Partido", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPartido = 1,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2944),
                            Duration = "2 horas",
                            Estrellas = "5",
                            IdUser = 1,
                            Name = "Partido 1",
                        ...
                        {
                            IdPartido = 2,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2948),
                        ...
                        {
                            IdPartido = 3,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2950),
                            Duration = "2 horas",
                            Estrellas = "4.5",
                            IdUser = 3,
                            Name = "Partido 3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Pista", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPista = 1,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2825),
                            Description = "Pista 1",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 1",
                            Photo = "photo1",
                        ...
                        {
                            IdPista = 2,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2872),
                            Description = "Pista 2",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 2",
                            Photo = "photo2",
                        ...
                        {
                            IdPista = 3,
                            Date = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2875),
                            Description = "Pista 3",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 3",
                            Photo = "photo3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdSesion = 1,
                            IdUser = 1,
                            ReservationDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2906),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 2,
                            IdUser = 2,
                            ReservationDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2909),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 3,
                            IdUser = 3,
                            ReservationDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2911),
                            ReservationPrice = "10"
                        });
                });
            ...
            modelBuilder.Entity("TFGBackend.Models.Sesion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdPista = 1,
                            Reservado = false,
                            SesionDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2925),
                            SesionTime = "10:00"
                        },
                        new
                        {
                            ...
                            IdPista = 2,
                            Reservado = false,
                            SesionDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2928),
                            SesionTime = "12:00"
                        },
                        new
                        {
                            ...
                            IdPista = 3,
                            Reservado = false,
                            SesionDate = new DateTime(2024, 6, 3, 18, 49, 10, 908, DateTimeKind.Local).AddTicks(2930),
                            SesionTime = "14:00"
                        });
                });
