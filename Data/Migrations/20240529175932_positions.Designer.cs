...
namespace TFGBackend.Data.Migrations
{
    ...
    [Migration("20240529175932_positions")]
            ...
            modelBuilder.Entity("TFGBackend.Models.Partido", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPartido = 1,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8653),
                            Duration = "2 horas",
                            Estrellas = "5",
                            IdUser = 1,
                            Name = "Partido 1",
                        ...
                        {
                            IdPartido = 2,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8656),
                        ...
                        {
                            IdPartido = 3,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8659),
                            Duration = "2 horas",
                            Estrellas = "4.5",
                            IdUser = 3,
                            Name = "Partido 3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Pista", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPista = 1,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8546),
                            Description = "Pista 1",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 1",
                            Photo = "photo1",
                        ...
                        {
                            IdPista = 2,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8585),
                            Description = "Pista 2",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 2",
                            Photo = "photo2",
                        ...
                        {
                            IdPista = 3,
                            Date = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8588),
                            Description = "Pista 3",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 3",
                            Photo = "photo3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdSesion = 1,
                            IdUser = 1,
                            ReservationDate = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8620),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 2,
                            IdUser = 2,
                            ReservationDate = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8624),
                            ReservationPrice = "10"
                        },
                        new
                        {
                            ...
                            IdSesion = 3,
                            IdUser = 3,
                            ReservationDate = new DateTime(2024, 5, 29, 19, 59, 32, 1, DateTimeKind.Local).AddTicks(8625),
                            ReservationPrice = "10"
                        });
                });
