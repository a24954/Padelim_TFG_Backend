...
namespace TFGBackend.Data.Migrations
{
    ...
    [Migration("20240523181603_AddCompras")]
            ...
            modelBuilder.Entity("TFGBackend.Models.Partido", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPartido = 1,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8149),
                            Duration = "2 horas",
                            Estrellas = "5",
                            IdUser = 1,
                            Name = "Partido 1",
                        ...
                        {
                            IdPartido = 2,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8153),
                        ...
                        {
                            IdPartido = 3,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8155),
                            Duration = "2 horas",
                            Estrellas = "4.5",
                            IdUser = 3,
                            Name = "Partido 3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Pista", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPista = 1,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8028),
                            Description = "Pista 1",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 1",
                            Photo = "photo1",
                        ...
                        {
                            IdPista = 2,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8077),
                            Description = "Pista 2",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 2",
                            Photo = "photo2",
                        ...
                        {
                            IdPista = 3,
                            Date = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8080),
                            Description = "Pista 3",
                            Duration = "1 hora y 30 minutos",
                            Name = "Pista 3",
                            Photo = "photo3",
            ...
            modelBuilder.Entity("TFGBackend.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdSesion = 0,
                            IdUser = 0,
                            ReservationDate = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8114),
                            ReservationPrice = "10",
                        ...
                        new
                        {
                            ...
                            IdSesion = 0,
                            IdUser = 0,
                            ReservationDate = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8117),
                            ReservationPrice = "10",
                            SesionTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            IdSesion = 0,
                            IdUser = 0,
                            ReservationDate = new DateTime(2024, 5, 23, 20, 16, 2, 954, DateTimeKind.Local).AddTicks(8119),
                            ReservationPrice = "10",
                            SesionTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
